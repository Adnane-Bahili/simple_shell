...
void handle_exit_err(char *argv, char **args, int count);

/**
 * handle_cmd_err - a function that checks for commands errors
 ...
 * Return: void.
 */
void handle_cmd_err(char *argv, char *cmd, int count, int check_path,
		int *exit_status)
{
	int y;
	char *num, *token;
...
/**
 * handle_exit_err - a function that checks for exit errors
 * @argv: argument vectors
 * @args: command line
 * @count: the counter of main function
 *
